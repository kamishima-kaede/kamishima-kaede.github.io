...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="nvm-不推荐" tabindex="-1"><a class="header-anchor" href="#nvm-不推荐" aria-hidden="true">#</a> <code>nvm</code>(不推荐)</h2><p>nodejs版本管理工具</p>`,21),_={href:"https://github.com/coreybutler/nvm-windows/releases",target:"_blank",rel:"noopener noreferrer"},y=n("br",null,null,-1),x={href:"https://github.com/nvm-sh/nvm",target:"_blank",rel:"noopener noreferrer"},N=i(`<p>设置镜像</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>nvm node_mirror https://npmmirror.com/mirrors/node/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="ubuntu镜像" tabindex="-1"><a class="header-anchor" href="#ubuntu镜像" aria-hidden="true">#</a> <code>Ubuntu</code>镜像</h2><p>手动更改<br> 用你熟悉的编辑器打开：<code>/etc/apt/sources.list</code>,替换默认的连接</p>`,12),S={href:"https://mirrors.ustc.edu.cn/repogen/",target:"_blank",rel:"noopener noreferrer"},M=n("code",null,"Archlinux",-1),P=n("code",null,"Debian",-1),V=n("code",null,"Ubuntu",-1),L=n("p",null,[s("其他"),n("code",null,"Ubuntu"),s("国内镜像源请在头部连接中查找")],-1);function B(E,I){const e=l("ExternalLinkIcon");return o(),c("div",null,[p,t(" more "),m,n("ul",null,[n("li",null,[n("a",u,[s("中科大镜像源"),a(e)])]),n("li",null,[n("a",v,[s("阿里巴巴开源镜像站"),a(e)])]),n("li",null,[n("a",b,[s("华为开源镜像站"),a(e)])])]),h,n("p",null,[s("官网:"),n("a",g,[s("中文"),a(e)]),s("|"),n("a",k,[s("英文"),a(e)])]),f,n("blockquote",null,[n("p",null,[s("for windows: "),n("a",_,[s("nvm-windows"),a(e)]),y,s(" for mac/linux: "),n("a",x,[s("nvm-sh/nvm"),a(e)])])]),N,n("p",null,[n("a",j,[s("国内NPM镜像"),a(e)])]),w,n("p",null,[s("本人一般使用中科大源,这是一个中科大源镜像生成工具"),n("a",S,[s("https://mirrors.ustc.edu.cn/repogen/"),a(e)]),s(",包括"),M,s("、"),P,s("、"),V]),L])}const A=r(d,[["render",B],["__file","mirror_source.html.vue"]]);export{A as default};
