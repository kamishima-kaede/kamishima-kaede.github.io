...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="安装node-js" tabindex="-1"><a class="header-anchor" href="#安装node-js" aria-hidden="true">#</a> 安装<code>Node.js</code></h2>`,16),m={href:"https://github.com/nvm-sh/nvm",target:"_blank",rel:"noopener noreferrer"},b=n("code",null,"node",-1),h=n("p",null,[n("s",null,[e("安装"),n("code",null,"nvm")]),n("br"),n("s",null,"curl -o- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.1/install.sh | bash"),n("br"),n("s",null,"或者"),n("br"),n("s",null,"wget -qO- https://raw.githubusercontent.com/nvm-sh/nvm/v0.39.1/install.sh | bash")],-1),g={href:"https://pnpm.io/",target:"_blank",rel:"noopener noreferrer"},f=n("code",null,"Node.js",-1),x=i(`<h2 id="nginx" tabindex="-1"><a class="header-anchor" href="#nginx" aria-hidden="true">#</a> <code>Nginx</code></h2><h3 id="安装-1" tabindex="-1"><a class="header-anchor" href="#安装-1" aria-hidden="true">#</a> 安装</h3><p>安装</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">sudo</span> <span class="token function">apt</span> update
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>把<code>nginx.conf</code>文件中的<code>server_tokens on</code>改成<code>server_tokens off</code>就可以了</p><p>有的配置里没有<code>server_tokens on</code>的 直接添加<code>server_tokens off</code>即可</p><h2 id="免费ssl证书启用" tabindex="-1"><a class="header-anchor" href="#免费ssl证书启用" aria-hidden="true">#</a> 免费<code>SSL</code>证书启用</h2>`,13),w=n("code",null,"Certbot",-1),y=n("code",null,"ubuntu + nginx",-1),S={href:"https://certbot.eff.org/",target:"_blank",rel:"noopener noreferrer"},q=i(`<p>1.安装<code>snapd</code>,通过<code>snapd</code>安装<code>certbot</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 安装snapd</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考" tabindex="-1"><a class="header-anchor" href="#参考" aria-hidden="true">#</a> 参考</h2>`,18),z={href:"https://segmentfault.com/a/1190000016555800",target:"_blank",rel:"noopener noreferrer"},N={href:"https://segmentfault.com/a/1190000024552266",target:"_blank",rel:"noopener noreferrer"},j={href:"http://blog.cngal.org/index.php?controller=post&action=view&id_post=10",target:"_blank",rel:"noopener noreferrer"},L={href:"https://www.myfreax.com/how-to-setup-a-firewall-with-ufw-on-ubuntu-20-04/",target:"_blank",rel:"noopener noreferrer"};function U(F,C){const a=d("ExternalLinkIcon"),l=d("RouterLink"),t=d("Badge");return r(),p("div",null,[v,n("p",null,[n("s",null,[e("推荐使"),n("a",m,[e("nvm"),s(a)]),e("版本管理工具管理"),b,e("版本")])]),h,n("p",null,[e("推荐使用"),n("a",g,[e("pnpm"),s(a)]),e("安装和管理"),f]),n("p",null,[e("可以参考之前的"),s(l,{to:"/dev-tools/mirror_source.html#pnpm"},{default:c(()=>[e("教程")]),_:1})]),x,n("p",null,[e("补充知识点："),n("a",k,[e("正向代理反向代理的区别"),s(a)])]),_,s(t,{text:"tip",type:"tip"}),e("如有需求泛域名证书申请安装及配置的可以参考这篇"),s(l,{to:"/website_build/domainNameSSL.html"},{default:c(()=>[e("教程")]),_:1}),n("p",null,[e("这里使用"),w,e("获取证书,以下操作适用于"),y,e(",其他环境可以参考"),n("a",S,[e("Certbot官网"),s(a)])]),q,n("ul",null,[n("li",null,[e("[1] "),n("a",z,[e("10分钟搭建ubuntu+nodejs+pm2自动部署+nginx+永久免费SSL证书+mongodb自动部署环境"),s(a)])]),n("li",null,[e("[2] "),n("a",N,[e("如何自动申请免费的SSL 证书"),s(a)])]),n("li",null,[e("[3] "),n("a",j,[e("Let’s Encrypt免费SSL证书获取以及自动续签"),s(a)])]),n("li",null,[e("[4] "),n("a",L,[e("如何在Ubuntu 20.04上使用UFW配置防火墙"),s(a)])])])])}const P=o(u,[["render",U],["__file","environment_server.html.vue"]]);export{P as default};
