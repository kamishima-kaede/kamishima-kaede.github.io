import{_ as r}from"./plugin-vue_export-helper-c27b6911.js";import{r as l,o,c,e as t,b as n,d as e,a,f as i}from"./app-50528f77.js";const d={},p=n("p",null,"开发过程中常用的镜像资源收集记录",-1),m=n("p",null,"本人常用的镜像站点:",-1),u={href:"https://mirrors.ustc.edu.cn/",target:"_blank",rel:"noopener noreferrer"},v={href:"https://developer.aliyun.com/mirror/",target:"_blank",rel:"noopener noreferrer"},b={href:"https://mirrors.huaweicloud.com/",target:"_blank",rel:"noopener noreferrer"},h=n("h2",{id:"pnpm",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#pnpm","aria-hidden":"true"},"#"),e(),n("code",null,"pnpm")],-1),g={href:"https://pnpm.io/zh",target:"_blank",rel:"noopener noreferrer"},k={href:"https://pnpm.io/",target:"_blank",rel:"noopener noreferrer"},f=i(`<p><code>pnpm</code>不仅能作为<code>JavaScript</code>的包管理工具,而且可以作为<code>nodejs</code>的版本管理工具</p><p>在 POSIX 类系统上，即使尚未安装 Node.js，也可以使用以下脚本安装 pnpm：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">-fsSL</span> https://get.pnpm.io/install.sh <span class="token operator">|</span> <span class="token function">sh</span> -
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p><code>.npmrc</code>文件所在位置如下,根据具体情况在所在位置创建:</p><ul><li>全局配置文件：<code>/etc/npmrc</code></li><li>用户配置文件：<code>~/.npmrc</code></li><li>项目配置文件：<code>$项目根目录/.npmrc</code></li></ul><p>设置<code>Node.js</code>镜像地址：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">pnpm</span> config <span class="token builtin class-name">set</span> node-mirror:release https://mirrors.aliyun.com/nodejs-release/
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>或者编辑<code>.npmrc</code>,添加如下:</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>node-mirror:release<span class="token operator">=</span>https://mirrors.aliyun.com/nodejs-release/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="nvm-不推荐" tabindex="-1"><a class="header-anchor" href="#nvm-不推荐" aria-hidden="true">#</a> <code>nvm</code>(不推荐)</h2><p>nodejs版本管理工具</p>`,21),_={href:"https://github.com/coreybutler/nvm-windows/releases",target:"_blank",rel:"noopener noreferrer"},y=n("br",null,null,-1),x={href:"https://github.com/nvm-sh/nvm",target:"_blank",rel:"noopener noreferrer"},j=i(`<p>设置镜像</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>nvm node_mirror https://npmmirror.com/mirrors/node/
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3.NPM镜像的管理工具<br> 安装：</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> <span class="token function">install</span> <span class="token parameter variable">-g</span> nrm
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>3.YARN镜像的管理工具<br> 安装：<code>yarn global add yrm</code></p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token comment"># 查看所有镜像</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="ubuntu镜像" tabindex="-1"><a class="header-anchor" href="#ubuntu镜像" aria-hidden="true">#</a> <code>Ubuntu</code>镜像</h2><p>手动更改<br> 用你熟悉的编辑器打开：<code>/etc/apt/sources.list</code>,替换默认的连接</p>`,12),S={href:"https://mirrors.ustc.edu.cn/repogen/",target:"_blank",rel:"noopener noreferrer"},M=n("code",null,"Archlinux",-1),P=n("code",null,"Debian",-1),V=n("code",null,"Ubuntu",-1),L=n("p",null,[e("其他"),n("code",null,"Ubuntu"),e("国内镜像源请在头部连接中查找")],-1);function B(E,I){const s=l("ExternalLinkIcon");return o(),c("div",null,[p,t(" more "),m,n("ul",null,[n("li",null,[n("a",u,[e("中科大镜像源"),a(s)])]),n("li",null,[n("a",v,[e("阿里巴巴开源镜像站"),a(s)])]),n("li",null,[n("a",b,[e("华为开源镜像站"),a(s)])])]),h,n("p",null,[e("官网:"),n("a",g,[e("中文"),a(s)]),e("|"),n("a",k,[e("英文"),a(s)])]),f,n("blockquote",null,[n("p",null,[e("for windows: "),n("a",_,[e("nvm-windows"),a(s)]),y,e(" for mac/linux: "),n("a",x,[e("nvm-sh/nvm"),a(s)])])]),j,n("p",null,[n("a",N,[e("国内NPM镜像"),a(s)])]),w,n("p",null,[e("本人一般使用中科大源,这是一个中科大源镜像生成工具"),n("a",S,[e("https://mirrors.ustc.edu.cn/repogen/"),a(s)]),e(",包括"),M,e("、"),P,e("、"),V]),L])}const A=r(d,[["render",B],["__file","mirror_source.html.vue"]]);export{A as default};
