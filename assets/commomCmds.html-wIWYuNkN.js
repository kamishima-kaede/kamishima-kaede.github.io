import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,b as e}from"./app-DeZCnSkw.js";const i="/assets/001-B9nHpBhJ.png",c={},l=e('<figure><img src="'+i+`" alt="docker常用命令" tabindex="0" loading="lazy"><figcaption>docker常用命令</figcaption></figure><h2 id="帮助启动类命令" tabindex="-1"><a class="header-anchor" href="#帮助启动类命令"><span>帮助启动类命令</span></a></h2><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 启动docker： </span>
