import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,o as s,b as e}from"./app-DzQ4eOgD.js";const t={},i=e(`<h1 id="应用和包管理" tabindex="-1"><a class="header-anchor" href="#应用和包管理"><span>应用和包管理</span></a></h1><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 列出系统已安装应用</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>缓存策略：减轻软件源服务器检索压力提升用户体验，在本地保存一份软件源中的信息副本。</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 安全软件前同步本地副本，防止本地缓存与服务器信息不一致导致安装软件失败</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>虽然在实际安装过程中只有<code>dpkg -i</code>命令是必需的，其他都可以忽略，但安装前后查看一下安装文件的内容是提高安全性的好习惯。</p><p><code>dpkg</code>也提供了列出系统中已安装应用的功能</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># -l 是 --list 的简写</span>
...
dpkg <span class="token parameter variable">-l</span> googler
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>2.查询</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># -S 是 --search 的简写</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>3.卸载</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 卸载完成后查询</span>
<span class="token function">sudo</span> dpkg <span class="token parameter variable">-r</span> googler
dpkg <span class="token parameter variable">-l</span> googler
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><code>gdebi</code>工具：自动解析要安装的<code>deb</code>包的依赖，以及依赖的依赖，然后自动完成下载和安装。</p><p>所以下次安装<code>deb</code>包的时候，用<code>sudo gdebi googler_4.3.1-1_ubuntu20.04. amd64.deb</code>代替<code>sudo dpkg -i googler_4.3.1-1_ubuntu20.04.amd64.deb</code>即可。</p><p>4.安全</p><p>关于<code>dpkg</code>工具的最后一个话题与它的安全性有关。前面说过在安装之前可以通过<code>-I</code>、<code>-c</code>等参数检查包的元数据和内容，但这些方法不能发现可执行文件内部隐藏的恶意代码。所以为了保证系统安全，要养成只在官网下载<code>deb</code>包的习惯。对于从第三方得到的包，除非来源完全可靠，否则尽量不要安装。</p><h2 id="跨平台包管理器" tabindex="-1"><a class="header-anchor" href="#跨平台包管理器"><span>跨平台包管理器</span></a></h2>`,20),l=[i];function p(c,o){return s(),a("div",null,l)}const m=n(t,[["render",p],["__file","package.html.vue"]]),u=JSON.parse(`{"path":"/linux/package.html","title":"应用和包管理","lang":"zh-CN","frontmatter":{"article":false,"date":"2024-05-21T00:00:00.000Z","description":"应用和包管理 缓存策略：减轻软件源服务器检索压力提升用户体验，在本地保存一份软件源中的信息副本。 使用dpkg管理应用 1.安装 手动安装deb包的一个常见原因:发行版要维护大量包，这些包都是独立开发的，彼此之间不会互相协调进度，保证兼容。所以避免发行版出现内部版本冲突的重任就落到了发行版维护者身上，而发行版维护者资源有限，不可能随时跟进每个包的新版本...","head":[["meta",{"property":"og:url","content":"https://hanekawa.top/linux/package.html"}],["meta",{"property":"og:site_name","content":"Kamishima-kaede"}],["meta",{"property":"og:title","content":"应用和包管理"}],["meta",{"property":"og:description","content":"应用和包管理 缓存策略：减轻软件源服务器检索压力提升用户体验，在本地保存一份软件源中的信息副本。 使用dpkg管理应用 1.安装 手动安装deb包的一个常见原因:发行版要维护大量包，这些包都是独立开发的，彼此之间不会互相协调进度，保证兼容。所以避免发行版出现内部版本冲突的重任就落到了发行版维护者身上，而发行版维护者资源有限，不可能随时跟进每个包的新版本..."}],["meta",{"property":"og:type","content":"website"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2024-05-21T09:04:52.000Z"}],["meta",{"property":"article:author","content":"kamishima-kaede"}],["meta",{"property":"article:published_time","content":"2024-05-21T00:00:00.000Z"}],["meta",{"property":"article:modified_time","content":"2024-05-21T09:04:52.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"WebPage\\",\\"name\\":\\"应用和包管理\\",\\"description\\":\\"应用和包管理 缓存策略：减轻软件源服务器检索压力提升用户体验，在本地保存一份软件源中的信息副本。 使用dpkg管理应用 1.安装 手动安装deb包的一个常见原因:发行版要维护大量包，这些包都是独立开发的，彼此之间不会互相协调进度，保证兼容。所以避免发行版出现内部版本冲突的重任就落到了发行版维护者身上，而发行版维护者资源有限，不可能随时跟进每个包的新版本...\\"}"]]},"headers":[{"level":3,"title":"使用dpkg管理应用","slug":"使用dpkg管理应用","link":"#使用dpkg管理应用","children":[]},{"level":2,"title":"跨平台包管理器","slug":"跨平台包管理器","link":"#跨平台包管理器","children":[]}],"git":{"createdTime":1679046743000,"updatedTime":1716282292000,"contributors":[{"name":"shiki ryougi","email":"shikiryougi@shikideMacBook.local","commits":3},{"name":"shiki","email":"kamiacgxu@gmail.com","commits":2}]},"readingTime":{"minutes":2.86,"words":857},"filePathRelative":"linux/package.md","localizedDate":"2024年5月21日","excerpt":"\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code><span class=\\"token comment\\"># 列出系统已安装应用</span>\\n<span class=\\"token function\\">apt</span> list <span class=\\"token parameter variable\\">--installed</span>\\n\\n<span class=\\"token comment\\"># 使用分页器</span>\\n<span class=\\"token function\\">apt</span> list <span class=\\"token parameter variable\\">--installed</span> <span class=\\"token operator\\">|</span> <span class=\\"token function\\">less</span> <span class=\\"token parameter variable\\">-N</span>\\n<span class=\\"token comment\\"># 输入 /apt 并按回车键，然后按 n 键，就会将每一个匹配到的 apt 字符串放到分页器第一行</span>\\n<span class=\\"token comment\\"># / 后可以加正则表达式</span>\\n\\n<span class=\\"token comment\\"># 过滤命令 grep</span>\\n<span class=\\"token function\\">apt</span> list <span class=\\"token parameter variable\\">--installed</span> <span class=\\"token operator\\">|</span> <span class=\\"token function\\">grep</span> <span class=\\"token string\\">'^apt'</span> <span class=\\"token operator\\">&gt;</span> apt_related_pkgs\\n</code></pre></div>","autoDesc":true}`);export{m as comp,u as data};
