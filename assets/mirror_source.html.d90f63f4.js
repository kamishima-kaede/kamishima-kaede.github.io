...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="ubuntu镜像" tabindex="-1"><a class="header-anchor" href="#ubuntu镜像" aria-hidden="true">#</a> <code>Ubuntu</code>镜像</h2><p>手动更改<br> 用你熟悉的编辑器打开：<code>/etc/apt/sources.list</code>,替换默认的连接</p>`,12),j={href:"https://mirrors.ustc.edu.cn/repogen/",target:"_blank",rel:"noopener noreferrer"},N=n("code",null,"Archlinux",-1),w=n("code",null,"Debian",-1),S=n("code",null,"Ubuntu",-1),M=n("p",null,[s("其他"),n("code",null,"Ubuntu"),s("国内镜像源请在头部连接中查找")],-1);function P(L,V){const e=c("ExternalLinkIcon");return l(),o("div",null,[d,n("ul",null,[n("li",null,[n("a",p,[s("中科大镜像源"),a(e)])]),n("li",null,[n("a",m,[s("阿里巴巴开源镜像站"),a(e)])]),n("li",null,[n("a",u,[s("华为开源镜像站"),a(e)])])]),v,n("p",null,[s("官网:"),n("a",b,[s("中文"),a(e)]),s("|"),n("a",h,[s("英文"),a(e)])]),g,n("blockquote",null,[n("p",null,[s("for windows: "),n("a",k,[s("nvm-windows"),a(e)]),s(" for mac/linux: "),n("a",f,[s("nvm-sh/nvm"),a(e)])])]),_,n("p",null,[n("a",y,[s("中国NPM镜像"),a(e)])]),x,n("p",null,[s("本人一般使用中科大源,这是一个中科大源镜像生成工具"),n("a",j,[s("https://mirrors.ustc.edu.cn/repogen/"),a(e)]),s(",包括"),N,s("、"),w,s("、"),S]),M])}const I=r(t,[["render",P],["__file","mirror_source.html.vue"]]);export{I as default};
